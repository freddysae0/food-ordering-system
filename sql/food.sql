...
INSERT INTO
    `order_details` (`id`, `order_id`, `item_id`, `quantity`, `price`)
VALUES
    (1, 1, 2, 2, 90),
    (2, 1, 3, 3, 60),
    (3, 2, 2, 2, 90),
...
VALUES
    ...
    (
        ...
        1,
        1,
        'Reply-2 for Subject 1 from Administrator.',
        '2017-03-30 20:35:39'
    ),
    (
        4,
...
INSERT INTO
    `wallet_details` (`id`, `wallet_id`, `number`, `cvv`, `balance`)
VALUES
